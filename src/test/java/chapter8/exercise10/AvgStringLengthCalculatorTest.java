...
public class AvgStringLengthCalculatorTest {
    ...
    public void whenStreamNotEmpty_returnsAverageWorldLength() {
        assertThat(calculate(NOT_EMPTY_STREAM), equalTo(EXPECTED_NOT_EMPTY_STREAM_AVG_WORD_LEN));
    }

    @Test
    public void whenStreamEmpty_returnsZero() {
        assertThat(calculate(EMPTY_STREAM), equalTo(EXPECTED_EMPTY_STREAM_AVG_WORD_LEN));
    }
}
